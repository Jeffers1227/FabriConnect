        ...
        <div className="col-lg-7">
          ...
          <div className="card glass-card p-4 mb-5 border-0 shadow-lg" style={{backgroundColor: '#1e293b'}}>
            ...
            <div className="row g-4">
              ...
              <div className="col-md-6"><label className="form-label text-white-50">DNI / Carnet</label><input type="text" name="dni" value={formData.dni} onChange={handleInputChange} className="form-control dark-input text-white" /></div>
              <div className="col-md-6"><label className="form-label text-white-50">Correo Electrónico</label><div className="input-group"><span className="input-group-text dark-input border-end-0"><Mail size={18}/></span><input type="email" name="correo" value={formData.correo} onChange={handleInputChange} className="form-control dark-input border-start-0 text-white" /></div></div>
              <div className="col-md-6"><label className="form-label text-white-50">Teléfono Móvil</label><div className="input-group"><span className="input-group-text dark-input border-end-0"><Phone size={18}/></span><input type="text" name="telefono" value={formData.telefono} onChange={handleInputChange} className="form-control dark-input border-start-0 text-white" /></div></div>
            </div>
          </div>
